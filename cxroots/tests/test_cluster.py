...
class TestCluster_1_rect(unittest.TestCase, TestCluster):
	def setUp(self):
...
class TestCluster_1_circle(unittest.TestCase, TestCluster):
	def setUp(self):
		self.roots = roots = [3, 3.01, 3.02, 8, 8.02, 8+0.01j]
		self.multiplicities = [1,1,1,1,1,1]
...
class TestCluster_2_rect(unittest.TestCase, TestCluster):
	def setUp(self):
...
class TestCluster_2_circle(unittest.TestCase, TestCluster):
	def setUp(self):
		self.roots = roots = [3, 3.001, 3.002, 8, 8.002, 8+0.001j]
		self.multiplicities = [1,1,1,1,1,1]
...
class TestCluster_3_rect(unittest.TestCase, TestCluster):
	def setUp(self):
...
class TestCluster_3_circle(unittest.TestCase, TestCluster):
	def setUp(self):
		self.roots = roots = [3, 3.0001, 3.0002, 8, 8.0002, 8+0.0001j]
		self.multiplicities = [1,1,1,1,1,1]
...
class TestCluster_4_rect(unittest.TestCase, TestCluster):
	def setUp(self):
...
class TestCluster_4_circle(unittest.TestCase, TestCluster):
	def setUp(self):
		self.roots = roots = [3, 3.00001, 3.00002, 8, 8.00002, 8+0.00001j]
		self.multiplicities = [1,1,1,1,1,1]
